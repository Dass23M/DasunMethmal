...
export default function ThreeDRotator() {
  ...
  return (
    <section ref={containerRef} className="w-full h-[380px] xs:h-[450px] sm:h-[550px] md:h-[650px] bg-gray-50 dark:bg-black flex items-center justify-center overflow-hidden py-8 sm:py-12 relative z-20 select-none">
          ...
          {Array.from({ length: N }).map((_, i) => (
            <div key={i} className="die-3d w-[400px] h-[55px] pb-[9px] relative [perspective:999px]">
              <div className="cube-3d absolute w-full h-full [transform-style:preserve-3d]">
                <div className="face-3d absolute w-full h-full flex items-center justify-center [backface-visibility:hidden] font-display font-black text-[58px] tracking-tight">CODE</div>
                <div className="face-3d absolute w-full h-full flex items-center justify-center [backface-visibility:hidden] font-display font-black text-[56px] tracking-tight">DRIVEN</div>
                <div className="face-3d absolute w-full h-full flex items-center justify-center [backface-visibility:hidden] font-display font-black text-[54px] tracking-tight">ANIMATION</div>
              </div>
            </div>
          ))}
        </div>
