    ...
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(
        ...
        .fromTo(
          ...
          { scale: 1, rotate: 0, opacity: 1, duration: 1.4, ease: 'back.out(1.4)' },
          '-=1.0'
        )
        .fromTo(
          '.impact-top-photo',
        ...
        .fromTo(
          '.impact-crosshair',
          { scale: 0, opacity: 0 },
          { scale: 1, opacity: 1, duration: 0.8, stagger: 0.12, ease: 'back.out(2)' },
          '-=0.8'
        )
        .fromTo(
          '.impact-bio-text',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start mb-10 sm:mb-14 lg:mb-20">
          ...
          <div className="lg:col-span-7">
            <h2 className="font-raleway font-black text-3xl xs:text-4xl sm:text-6xl md:text-7xl lg:text-[5.2rem] leading-[0.96] tracking-tight uppercase">
              <span className="impact-title-line block text-black">MY IMPACT</span>
              ...
              <span className="impact-title-line block text-gray-400 font-extrabold">EXPERIENCE</span>
            </h2>
          </div>
