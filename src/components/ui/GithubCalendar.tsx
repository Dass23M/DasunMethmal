...
export const GithubCalendar = memo(function GithubCalendar({
  ...
  return (
    ...
    >
      <div className="w-fit mx-auto max-w-full flex flex-col gap-3 p-1 sm:p-3">
        <div
          ref={scrollRef}
          className={cn(
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
          {/* legend (left) */}
          {showLegend && (
            <div className="flex flex-wrap items-center gap-4 text-xs text-zinc-400 shrink-0 mt-0.5">
              ...
              <div className="flex items-center gap-2 border-l border-white/10 pl-4">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    gameActive ? "bg-[#FF6B00]" : "bg-neutral-800",
                  )}
                >
                  <span
                    className={cn(
          ...
          {/* stats line (right) */}
          {showStats && (
            <div className="flex flex-1 flex-wrap justify-center sm:justify-end ml-auto text-xs sm:text-sm font-mono tracking-wide">
              <a
              ...
              >
                ...
                <span>commits &amp; PRs this year</span>
                <span className="text-[#FF6B00] font-semibold underline decoration-[#FF6B00]/40 underline-offset-4">
                  ↗
                </span>
              </a>
            </div>
