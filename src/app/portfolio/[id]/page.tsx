...
export default function PortfolioSinglePage({ params }: Props) {
  ...
  return (
    <>
      ...
      />
      <div className="site-inner bg-gray-50 dark:bg-black text-black dark:text-white select-none">
        <Navbar />
        ...
        <div id="portfolio-detail-content" className="w-full bg-gray-50 dark:bg-black py-16 sm:py-24">
          <div className="w-full max-w-[1280px] mx-auto px-4 sm:px-8">
            
            {/* Top Navigation Bar */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-8 border-b border-black/10 dark:border-white/10 mb-8 sm:mb-16">
              <BackButtonClient />
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8 mb-8">
              <div className="bg-[#12131A] border border-black/10 dark:border-white/10 rounded-2xl p-4 sm:p-6 space-y-1">
              ...
              <div className="bg-[#12131A] border border-black/10 dark:border-white/10 rounded-2xl p-4 sm:p-6 space-y-2 flex flex-col justify-center">
                <span className="font-mono text-[10px] sm:text-xs font-bold text-[#FF6B00] uppercase tracking-widest block">
                  LINKS
                </span>
                <a
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 pt-8 border-t border-black/10 dark:border-white/10 mb-16 sm:mb-24">
            ...
            {project.highlights && project.highlights.length > 0 && (
              <div className="mb-16 sm:mb-24 pt-8 border-t border-black/10 dark:border-white/10">
            ...
            {(project.myContributions || project.keyFeatures) && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 sm:mb-24 pt-8 border-t border-black/10 dark:border-white/10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-8 border-t border-black/10 dark:border-white/10">
              <Link
                href={`/portfolio/${prevProject.id}`}
                className="group bg-[#12131A] hover:bg-[#FF6B00] border border-black/10 dark:border-white/10 hover:border-[#FF6B00] p-6 rounded-2xl transition-all duration-300 flex flex-col justify-between"
              >
              ...
              <Link
                ...
                className="group bg-[#12131A] hover:bg-[#FF6B00] border border-black/10 dark:border-white/10 hover:border-[#FF6B00] p-6 rounded-2xl transition-all duration-300 flex flex-col justify-between text-left sm:text-right"
              >
                <span className="font-mono text-[10px] font-bold text-black/50 dark:text-white/50 group-hover:text-black uppercase tracking-widest block mb-2">
                  NEXT PROJECT →
                </span>
