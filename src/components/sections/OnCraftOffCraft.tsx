...
export default function OnCraftOffCraft() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full min-h-[720px] lg:min-h-[800px] bg-[#F5F5F0] text-black overflow-hidden select-none py-16 lg:py-24 border-y border-black/10 flex items-center justify-center"
    >
