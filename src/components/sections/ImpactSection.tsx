...
export default function ImpactSection() {
  return (
    <section
      id="impact-section"
      className="relative w-full min-h-[580px] lg:min-h-[640px] bg-[#000000] text-black dark:text-white overflow-hidden select-none py-16 lg:py-24 flex flex-col justify-center"
    >
